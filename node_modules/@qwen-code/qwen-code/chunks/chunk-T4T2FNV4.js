...
var accessibilityContext = (0, import_react.createContext)({
...
var backgroundContext = (0, import_react2.createContext)(void 0);

// node_modules/ink/build/components/Box.js
var Box = (0, import_react3.forwardRef)(({ children, backgroundColor, "aria-label": ariaLabel, "aria-hidden": ariaHidden, "aria-role": role, "aria-state": ariaState, ...style }, ref) => {
  const { isScreenReaderEnabled } = (0, import_react3.useContext)(accessibilityContext);
  const label = ariaLabel ? import_react3.default.createElement("ink-text", null, ariaLabel) : void 0;
  if (isScreenReaderEnabled && ariaHidden) {
    return null;
  }
  const boxElement = import_react3.default.createElement("ink-box", { ref, style: {
    flexWrap: "nowrap",
    flexDirection: "row",
    flexGrow: 0,
    flexShrink: 1,
  ...
  if (backgroundColor) {
    return import_react3.default.createElement(backgroundContext.Provider, { value: backgroundColor }, boxElement);
  }
  return boxElement;
});
Box.displayName = "Box";
...
function Text({ color, backgroundColor, dimColor = false, bold = false, italic = false, underline = false, strikethrough = false, inverse = false, wrap = "wrap", children, "aria-label": ariaLabel, "aria-hidden": ariaHidden = false }) {
  const { isScreenReaderEnabled } = (0, import_react4.useContext)(accessibilityContext);
  const inheritedBackgroundColor = (0, import_react4.useContext)(backgroundContext);
  ...
  return import_react4.default.createElement("ink-text", { style: { flexGrow: 0, flexShrink: 1, flexDirection: "row", textWrap: wrap }, internal_transform: transform }, childrenOrAriaLabel);
}
__name(Text, "Text");
...
var isTmux = !isBrowser && (process3.env.TERM?.startsWith("screen") || process3.env.TERM?.startsWith("tmux") || process3.env.TMUX !== void 0);
...
var ANSI_SGR_MODIFIER_CLOSE_CODES = new Set(ansi_styles_default2.codes.values());
...
var devTty = /* @__PURE__ */ __name(() => {
  try {
    const flags = process4.platform === "darwin" ? fs.constants.O_EVTONLY | fs.constants.O_NONBLOCK : fs.constants.O_NONBLOCK;
    const { columns, rows } = tty2.WriteStream(fs.openSync("/dev/tty", flags));
    return { columns, rows };
  } catch {
  }
}, "devTty");
var tput = /* @__PURE__ */ __name(() => {
  try {
    const columns = exec2("tput", ["cols"], { env: { TERM: "dumb", ...process4.env } });
    const rows = exec2("tput", ["lines"], { env: { TERM: "dumb", ...process4.env } });
    if (columns && rows) {
...
var styles4 = /* @__PURE__ */ __name((node, style = {}, currentStyle = style) => {
...
if (process5.env["DEV"] === "true") {
  ...
  if (isDevtoolsInstalled) {
    await import("./devtools-FM6GJPYG.js");
  }
}
...
var reconciler_default = (0, import_react_reconciler.default)({
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  HostTransitionContext: (0, import_react5.createContext)(null),
  resetFormInstance() {
  },
...
var AppContext = (0, import_react6.createContext)(defaultValue);
...
var StdinContext = (0, import_react7.createContext)({
...
var StdoutContext = (0, import_react8.createContext)({
...
var StderrContext = (0, import_react9.createContext)({
...
var FocusContext = (0, import_react10.createContext)({
  activeId: void 0,
  add() {
  },
  remove() {
...
var animationContext = (0, import_react11.createContext)({
  renderThrottleMs: 0,
  subscribe() {
    return {
      startTime: 0,
...
var CursorContext = (0, import_react12.createContext)({
  setCursorPosition() {
  }
});
...
var useApp = /* @__PURE__ */ __name(() => (0, import_react17.useContext)(AppContext_default), "useApp");
...
function Static(props) {
  ...
  const itemsToRender = (0, import_react18.useMemo)(() => {
  ...
  return import_react18.default.createElement("ink-box", { internal_static: true, style }, children);
}
...
function Transform({ children, transform, accessibilityLabel }) {
  const { isScreenReaderEnabled } = (0, import_react19.useContext)(accessibilityContext);
  if (children === void 0 || children === null) {
    return null;
  }
  return import_react19.default.createElement("ink-text", { style: { flexGrow: 0, flexShrink: 1, flexDirection: "row" }, internal_transform: transform }, isScreenReaderEnabled && accessibilityLabel ? accessibilityLabel : children);
}
...
var useStdin = /* @__PURE__ */ __name(() => (0, import_react22.useContext)(StdinContext_default), "useStdin");
